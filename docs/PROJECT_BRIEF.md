        ...
        iniparse exists to solve a narrow, inspectable developer-tooling problem:
        Zero-dependency INI / config-file parser with section inheritance and ${...} interpolation.
        ...
        Topics: config, ini, parser, python, zero-dependencies
